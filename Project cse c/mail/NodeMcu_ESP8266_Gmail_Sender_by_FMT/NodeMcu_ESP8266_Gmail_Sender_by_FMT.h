...
class Gsender
{
    ...
    private:
        ...
        const char* EMAIL_LOGIN = "sandyvisu73@gmail.com"; //sender's gmail ID
        const char* EMAIL_PASSWORD = "vishesh121"; //sender's gmail account's password
        const char* FROM = "sandyvisu73@gmail.com"; // sender's gmail ID
        /*------------------------------------------------------*/
